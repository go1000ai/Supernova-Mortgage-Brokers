        ...
        <div className="min-h-screen bg-[#0e2922] text-white">
            ...
            <section className="relative pt-40 pb-20 overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto px-6 text-center">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#d29e4a]/10 border border-[#d29e4a]/20 text-[#e8c47a] text-xs font-medium mb-6">
            ...
            <section className="pb-20">
                ...
                >
                    <div className="bg-white/[0.02] border border-[#d29e4a]/10 rounded-2xl p-6 md:p-10 backdrop-blur-sm">
                        <MortgageCalculators />
                    </div>
                </motion.div>
            </section>
                ...
                <div className="relative max-w-3xl mx-auto px-6 text-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <motion.a
                                href="/#contact"
                                className="px-8 py-3.5 rounded-full bg-gradient-to-r from-[#d29e4a] to-[#e8c47a] text-[#0e2922] font-semibold shadow-lg shadow-[#d29e4a]/25 flex items-center gap-2"
                            ...
                            <a
                                href="tel:3213350399"
                                className="flex items-center gap-2 px-6 py-3.5 rounded-full border border-[#d29e4a]/30 text-[#e8c47a] text-sm font-medium hover:bg-[#d29e4a]/10 transition-colors"
                            >
